...
namespace Catalyst\PrivateCreditWebsite;
...
use Catalyst\PrivateCreditWebsite\Filament\Customer\Auth\Login;
use Catalyst\PrivateCreditWebsite\Filament\Customer\Auth\PasswordReset\RequestPasswordReset;
use Catalyst\PrivateCreditWebsite\Filament\Customer\Auth\PasswordReset\ResetPassword;
use Catalyst\PrivateCreditWebsite\Filament\Customer\Auth\Register;
use Catalyst\PrivateCreditWebsite\Filament\Customer\Clusters\Account;
...
class PrivateCreditWebsitePlugin implements Plugin
{
    public function getId(): string
    {
        return 'private-credit-website';
    }
        ...
        $panel
            ->when($panel->getId() == 'customer', function (Panel $panel) {
                $panel
                    ...
                    ->discoverResources(in: $this->getPluginBasePath('/Filament/Customer/Resources'), for: 'Catalyst\\PrivateCreditWebsite\\Filament\\Customer\\Resources')
                    ->discoverPages(in: $this->getPluginBasePath('/Filament/Customer/Pages'), for: 'Catalyst\\PrivateCreditWebsite\\Filament\\Customer\\Pages')
                    ->discoverClusters(in: $this->getPluginBasePath('/Filament/Customer/Clusters'), for: 'Catalyst\\PrivateCreditWebsite\\Filament\\Customer\\Clusters')
                    ->discoverClusters(in: $this->getPluginBasePath('/Filament/Customer/Widgets'), for: 'Catalyst\\PrivateCreditWebsite\\Filament\\Customer\\Widgets')
                    ->userMenuItems([
                    ...
                    ->renderHook(
                        ...
                        fn (): string => view('private-credit-website::filament.customer.header.auth-links', [
                            'navigationItems' => $this->getTopNavigationItems(),
                        ])->render(),
                    )
                    ->renderHook(
                        PanelsRenderHook::FOOTER,
                        fn (): string => view('private-credit-website::filament.customer.footer.index', [
            ...
            ->when($panel->getId() == 'admin', function (Panel $panel) {
                $panel
                    ->discoverResources(in: $this->getPluginBasePath('/Filament/Admin/Resources'), for: 'Catalyst\\PrivateCreditWebsite\\Filament\\Admin\\Resources')
                    ->discoverPages(in: $this->getPluginBasePath('/Filament/Admin/Pages'), for: 'Catalyst\\PrivateCreditWebsite\\Filament\\Admin\\Pages')
                    ->discoverClusters(in: $this->getPluginBasePath('/Filament/Admin/Clusters'), for: 'Catalyst\\PrivateCreditWebsite\\Filament\\Admin\\Clusters')
                    ->discoverClusters(in: $this->getPluginBasePath('/Filament/Admin/Widgets'), for: 'Catalyst\\PrivateCreditWebsite\\Filament\\Admin\\Widgets');
            });
    }
