...
namespace Catalyst\PrivateCreditWebsite\Filament\Customer\Auth\PasswordReset;
...
class RequestPasswordReset extends Page
{
     ...
     * @var view-string
     */
    protected static string $view = 'private-credit-website::filament.customer.pages.auth.password-reset.request-password-reset';
