...
use Catalyst\PrivateCreditWebsite\Filament\Admin\Resources\PartnerResource\Pages;
use Catalyst\PrivateCreditWebsite\Models\Partner;
...
class PartnerResource extends BasePartnerResource
{
    ...
    {
        return __('private-credit-website::filament/admin/resources/partner.navigation.title');
    }

    public static function getNavigationGroup(): ?string
    {
        return __('private-credit-website::filament/admin/resources/partner.navigation.group');
    }
